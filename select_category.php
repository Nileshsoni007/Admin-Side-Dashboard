...
<body>
<form method='post' >
<table border="2px" height="50%" width="40%" align="center" background="nilesh.jpg" >
<!--bordercolor="green"-->
<tr>

<td>
<table height="90%" width="95%" align="center" bgcolor="white" cellspacing="5" cellpadding="5" border="2" bordercolor="red"  background="nilesh.jpg">
<tr>
...
<tr>
	<th> category_id :</th>
	<th align='center'><input type="text" name="category_id" value="<?php echo $row['category_id'] ?>"></th>
</tr>
<tr>
	<th>Category Name :</th>
	<td>
